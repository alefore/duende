...
from code_specs import FileExtension, MarkerChar, MarkerImplementation, MarkerName, PathAndValidator, RepeatedExpandedMarkersError, Validator, comment_string, get_expanded_markers, get_markers, relevant_paths_variable
