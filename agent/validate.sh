...
for file in src/test_{args_common,async_confirmation_manager,command_registry,validate_command_input,write_file_command,agent_loop,read_file_command,search_file_command,shell_command_command}.py; do
